...
export default {
  ...
  methods: {
    ...
    refreshList() {
      ...
      this.$AxiosWithToken({
        url: this.BIZ_API_HOST + '/api/auth/merchant/repairBatchList',
        // method: 'post',
        params: {
    ...
    editRow(row, index) {
      this.$AxiosWithToken({
        url: this.BIZ_API_HOST + '/api/auth/merchant/repairBatch',
        // method: 'post',
        params: {
          // 用data适合后台用@RequestBody方式
          id: row.id
    ...
    editFormConfirm(formName) {
      this.$refs[formName].validate(state => {
        ...
        this.$AxiosWithToken({
          url: this.BIZ_API_HOST + '/api/auth/merchant/repairBatchEdit',
          method: 'post',
          data: {
            id: this.eForm.id,
    ...
    importFormConfirm(formName) {
      this.$refs[formName].validate(state => {
        ...
        this.$AxiosWithToken({
          url: this.BIZ_API_HOST + '/api/auth/merchant/repairBatchImportCases',
          method: 'post',
          headers: {
    ...
    doRepair(id) {
      this.$AxiosWithToken({
        url: this.BIZ_API_HOST + '/api/auth/merchant/repairBatchStart',
        // method: 'post',
        params: {
          // 用data适合后台用@RequestBody方式
          id: id
        ...
        if (res && res.code) {
          if (res.code === 200) {
            ...
            if (res.msg && res.msg === '-2') {
              ...
              this.$message.error('您的余额不足，请确保账户充足')
