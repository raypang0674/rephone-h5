...
export default {
  ...
  methods: {
    ...
    refreshList() {
      ...
      this.$AxiosWithToken({
        url: this.BIZ_API_HOST + '/api/auth/admin/repairCaseList',
        // method: 'post',
        params: {
    ...
    reloadCaller4Query4Select(query) {
      ...
      this.$AxiosWithToken({
        url: this.BIZ_API_HOST + '/api/auth/admin/callerList4Select',
        // method: 'post',
        params: {
          merchantId: this.merchantId,
          name: query,
    ...
    clickAssign() {
      ...
      this.$AxiosWithToken({
        url: this.BIZ_API_HOST + '/api/auth/admin/repairBatchCountCase4Assign',
        method: 'post',
        data: {
          batchId: this.batchId,
          merchantId: this.merchantId,
    ...
    assignFormConfirm(formName) {
      this.$refs[formName].validate(state => {
        ...
        this.$AxiosWithToken({
          url: this.BIZ_API_HOST + '/api/auth/admin/repairBatchAssign',
          method: 'post',
          data: {
            batchId: this.batchId,
            merchantId: this.merchantId,
